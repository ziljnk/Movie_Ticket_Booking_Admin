<style src="./manageVoucher.css"></style>

<script lang="ts" src="./manageVoucher.ts"></script>

<template>
    <ModalAddVoucher id="addVoucher" />
    <ModalDetailVoucher id="detailVoucher" />
                ...
                <div class="col-10 d-flex flex-column"
                    ...
                    <div class="d-flex flex-column"
                                ...
                                <div class="d-flex flex-row justify-content-between align-items-center"
                                    ...
                                    <button class="btn-add" data-bs-toggle="modal" data-bs-target="#addVoucher"><i
                                            class="bi bi-plus-lg"></i> Add new Voucher</button>
                                </div>
